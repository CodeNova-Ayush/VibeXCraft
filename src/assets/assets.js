...
import { Laptop, Boxes, Bot, BarChart3, Users, Settings, Code, Brain, Zap } from "lucide-react";

export const AiToolsData = [
  {
    title: "AI Workspace",
    description:
      "Code, test, and deploy with our built-in Judge0 IDE — your complete AI-powered coding environment.",
    path: "/ai/workspace",
    bg: { from: "#9B5CF5", to: "#00E0FF" },
    Icon: Laptop,
  },
  {
    title: "Projects",
    description:
      "Organize and showcase your creations. Sync with GitHub and collaborate in real-time with AI assistance.",
    path: "/ai/projects",
  ...
  },
  {
    title: "Community",
    description:
      "Connect with creators and developers, share your work, join challenges, and grow your network.",
    path: "/ai/community",
    bg: { from: "#00E0FF", to: "#5EEAD4" },
    Icon: Users,
  },
  {
    title: "Analytics",
    description:
      "Track your productivity, AI usage, and coding performance through interactive, real-time dashboards.",
    path: "/ai/analytics",
  ...
  },
  {
    title: "Code Arena",
    description:
      "Experiment, test, and debug your ideas in real time — powered by VibeXCraft’s integrated AI IDE.",
    path: "/ai/code-arena",
    bg: { from: "#22D3EE", to: "#3B82F6" },
    Icon: Code,
  },
  {
    title: "Settings",
    description:
      "Control your workspace, themes, integrations, and AI preferences all from one sleek dashboard.",
    path: "/ai/settings",
  ...
  },
  {
    title: "Vibe Mode",
    description:
      "Turn on immersive creative mode — a glowing neon environment for flow, focus, and AI-powered inspiration.",
    path: "/ai/vibe-mode",
    bg: { from: "#9B5CF5", to: "#EC4899" },
    Icon: Zap,
  },
];
